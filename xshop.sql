...
--
-- Host: localhost:3306
-- Generation Time: Mar 04, 2022 at 09:11 AM
...
INSERT INTO `bot` (`id`, `client`, `bot`) VALUES
(1, 'chào|hello|hi|Ê', 'Xin chào quý khách!');
...
INSERT INTO `rating` (`product_id`, `username`, `rating`) VALUES
(5, 'a', 5),
(5, 'an', 1),
(5, 'n', 4),
(19, 'an', 5);
...
--
ALTER TABLE `rating`
  ADD PRIMARY KEY (`product_id`,`username`) USING BTREE;
...
--
ALTER TABLE `rating`
  ADD CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `hanghoa` (`mahh`);
COMMIT;
